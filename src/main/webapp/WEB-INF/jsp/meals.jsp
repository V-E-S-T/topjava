            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="date" class="col-form-label"><spring:message code="meal.dateTime"/></label>
                        <input type="date" class="form-control" id="date" name="date"
                               placeholder="<spring:message code="meal.dateTime"/>">
                    </div>

                    <div class="form-group">
                        <label for="time" class="col-form-label"><spring:message code="meal.dateTime"/></label>
